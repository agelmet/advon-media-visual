...
export const PROOF = {
  el: '200+ ιστοσελίδες για ελληνικές επιχειρήσεις · 120+ κριτικές 5★ στο Google',
  en: '200+ websites for Greek businesses · 120+ 5★ reviews on Google',
};
...
export const services = [
  /* ───────────────────────── 1. Κατασκευή Ιστοσελίδων ───────────────────────── */
  {
    ...
    steps: [
      {
        ...
        body: {
          el: 'Φωτογραφίες, λίγα βασικά κείμενα, τη λίστα των υπηρεσιών σας και τα στοιχεία επικοινωνίας. Αν έχετε δει κάποια ιστοσελίδα που σας άρεσε — δική μας ή οποιαδήποτε άλλη — στείλτε τη μας κι αυτή.',
          en: 'Photos, a few short texts, your list of services and contact details. If you have seen a website you liked — ours or anyone else’s — send us that too.',
        },
      },
      {
        title: { el: 'Βλέπετε το πρώτο δείγμα', en: 'See the first draft' },
        body: {
          el: 'Μέσα σε 5–10 ημέρες σας παρουσιάζουμε την πρώτη έκδοση της σελίδας σας. Τότε μόνο εξοφλείται η φιλοξενία — καμία προκαταβολή πριν.',
          en: 'Within 5–10 days we present the first version of your website. Only then is hosting settled — no deposit before that.',
        },
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: {
          el: 'Μόλις λάβουμε το υλικό σας, το πρώτο δείγμα παραδίδεται μέσα σε 5–10 ημέρες. Από εκεί, ο χρόνος εξαρτάται από τις αλλαγές που θα θελήσετε — συνεχίζουμε μέχρι να είστε απόλυτα ικανοποιημένοι.',
          en: 'Once we receive your material, the first draft is delivered within 5–10 days. From there, timing depends on the changes you want — we keep going until you are fully happy.',
        },
      },
      {
      ...
      {
        q: { el: 'Μπορώ να σας δείξω μια ιστοσελίδα που μου αρέσει;', en: 'Can I show you a website I like?' },
        a: {
          el: 'Ναι, και μας βοηθάει πολύ. Στείλτε μας ένα link — μπορεί να είναι ιστοσελίδα άλλου επαγγελματία, ξένη, ή κάποια από το πορτφόλιό μας. Δεν την αντιγράφουμε, αλλά καταλαβαίνουμε αμέσως τι ύφος σας ταιριάζει και ξεκινάμε από εκεί.',
          en: 'Yes, and it helps a lot. Send us a link — it can be another professional’s website, a foreign one, or one from our own portfolio. We do not copy it, but we immediately understand which style suits you and we start from there.',
        },
      },
    ],
    card: {
  ...
  /* ───────────────────────── 2. Παρουσία στο Google ───────────────────────── */
  {
    ...
    pitch: {
      el: 'Στο Google δεν κερδίζει όποιος έχει την καλύτερη σελίδα — κερδίζει όποιος έχει τις περισσότερες πρόσφατες κριτικές. Το κάναμε για εμάς: 120+ κριτικές. Το ίδιο σύστημα, στημένο για εσάς.',
      en: "On Google, the winner isn't whoever has the best website — it's whoever has the most recent reviews. We did it for ourselves: 120+ reviews. The same system, set up for you.",
    },
    pitch2: {
  ...
  /* ───────────────────────── 7. Custom Μικρό Λογισμικό ───────────────────────── */
  {
    ...
    pitch: {
      el: 'Αυτό που βλέπετε στο demo δεν είναι μακέτα — είναι το πραγματικό σύστημα που τρέχει καθημερινά την Advon, φτιαγμένο ακριβώς όπως ονειρευόμασταν να δείχνει η δουλειά μας. Το ίδιο χτίζουμε και για εσάς, γύρω από τον δικό σας τρόπο δουλειάς.',
      en: "What you see in the demo isn't a mockup — it's the real system that runs Advon every day, built exactly as we dreamed our own work should look. We build the same for you, around the way you actually work.",
    },
    pain: [
      {
...
export const HOME_FAQS = [
  ...
  },
  {
    ...
    a: {
      el: 'Μόλις λάβουμε το υλικό σας — φωτογραφίες, βασικά κείμενα, στοιχεία επικοινωνίας — παραδίδουμε το πρώτο δείγμα σε 5–10 ημέρες. Από εκεί, ο χρόνος εξαρτάται μόνο από τις αλλαγές που θα θελήσετε.',
      en: 'Once we receive your material — photos, short texts, contact details — we deliver the first draft within 5–10 days. From there, timing depends only on the changes you want.',
    },
  },
  {
    q: { el: 'Τι γίνεται αν δεν μου αρέσει το αποτέλεσμα;', en: "What if I don't like the result?" },
