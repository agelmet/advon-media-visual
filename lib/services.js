...
export const services = [
  /* ───────────────────────── 1. Κατασκευή Ιστοσελίδων ───────────────────────── */
  {
    ...
    includes: [
      {
        el: 'Μοντέρνα, γρήγορη, δίγλωσση ιστοσελίδα, φτιαγμένη για το δικό σας επάγγελμα — όχι πρότυπο που φοράνε όλοι',
        en: 'A modern, fast, bilingual website built for your profession — not a template everyone wears',
      },
      {
  ...
  /* ───────────────────────── 3. Online Ραντεβού ───────────────────────── */
  {
    ...
    pain: [
      {
        el: 'Τα περισσότερα ραντεβού δεν ζητιούνται μέσα στο ωράριό σας. Ζητιούνται το βράδυ, την Κυριακή, την ώρα που έχετε πελάτη και δεν μπορείτε να σηκώσετε το τηλέφωνο. Κάποιοι θα ξαναπάρουν. Οι περισσότεροι όχι.',
      ...
      {
        el: 'Και όσα κλείνονται, θέλουν διαχείριση: τηλέφωνα, μηνύματα, «τελικά μπορώ Πέμπτη;», ακυρώσεις τελευταίας στιγμής, ραντεβού που ξεχάστηκαν. Ώρα δική σας, κάθε μέρα.',
    ...
    includes: [
      ...
      {
        el: 'Αυτόματες υπενθυμίσεις — τέλος τα ραντεβού που «ξεχάστηκαν»',
        en: 'Automatic reminders — no more “forgotten” appointments',
      },
      {
      ...
      {
        el: 'Από 5€/μήνα για έναν επαγγελματία · 15–35€/μήνα για ομάδες, ανάλογα με τα άτομα',
        en: 'From €5/month for one professional · €15–35/month for teams, depending on team size',
      },
    ],
    faqs: [
      {
        ...
        a: {
          el: 'Από 5€/μήνα για έναν επαγγελματία. Για ομάδες — κομμωτήρια, barbershops, ιατρεία — από 15 έως 35€/μήνα, ανάλογα με τα άτομα.',
          en: 'From €5/month for one professional. For teams — hair salons, barbershops, clinics — from €15 to €35/month, depending on team size.',
        },
      },
      {
  ...
  /* ───────────────────────── 4. AI Βοηθός Ιστοσελίδας ───────────────────────── */
  {
    ...
    pitch: {
      el: 'Οι περισσότεροι επισκέπτες μπαίνουν στη σελίδα σας όταν εσείς δεν μπορείτε να απαντήσετε. Κάθε αναπάντητος είναι χαμένη δουλειά — από εδώ και πέρα, κανένας δεν φεύγει χωρίς απάντηση.',
    ...
    pain: [
      {
        el: 'Οι περισσότεροι επισκέπτες μπαίνουν στη σελίδα σας εκτός ωραρίου — ή την ώρα που δουλεύετε και δεν μπορείτε να απαντήσετε. Έχουν μια απλή ερώτηση: «δέχεστε Σάββατο;», «πού ακριβώς είστε;», «κάνετε και αυτό;».',
        en: 'Most visitors reach your website outside working hours — or while you\'re working and can\'t respond. They have a simple question: “are you open Saturdays?”, “where exactly are you?”, “do you also do this?”.',
      },
      {
  ...
  /* ───────────────────────── 6. Ψηφιακό Μενού QR ───────────────────────── */
  {
    ...
    pain: [
      {
        el: 'Κάθε αλλαγή τιμής σημαίνει νέα εκτύπωση — ή διορθώσεις με στυλό πάνω στον κατάλογο, μπροστά στον πελάτη. Και κάθε καινούργιο πιάτο περιμένει την επόμενη παραγγελία στο τυπογραφείο για να υπάρξει.',
  ...
  /* ───────────────────────── 7. Custom Μικρό Λογισμικό ───────────────────────── */
  {
    ...
    pain: [
      ...
      {
        el: 'Γι΄ αυτό φτιάξαμε το δικό μας πρόγραμμα για την Advon, κι ας υπήρχαν παρόμοια: κάθε εργασία γίνεται πλέον στο μισό χρόνο. Το ίδιο μπορούμε να φτιάξουμε και για εσάς — γύρω από τον δικό σας τρόπο δουλειάς.',
    ...
    includes: [
      ...
      {
        el: 'Φτιάξαμε το δικό μας για την Advon, κι ας υπήρχαν παρόμοια: κάθε εργασία γίνεται πλέον στο μισό χρόνο',
