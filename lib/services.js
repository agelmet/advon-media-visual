...
export const PROOF = {
  el: '200+ ιστοσελίδες για ελληνικές επιχειρήσεις · 110+ κριτικές 5★ στο Google',
  en: '200+ websites for Greek businesses · 110+ 5★ reviews on Google',
};
...
export const services = [
    ...
    steps: [
      {
        ...
        body: {
          el: 'Φωτογραφίες, λίγα βασικά κείμενα, τη λίστα των υπηρεσιών σας και τα στοιχεία επικοινωνίας. Αν έχετε δει κάποια ιστοσελίδα που σας άρεσε — δική μας ή οποιαδήποτε άλλη — στείλτε τη μας κι αυτή. Την τελική κειμενογραφία την αναλαμβάνουμε εμείς.',
          en: 'Photos, a few short texts, your list of services and contact details. If you have seen a website you liked — ours or anyone else’s — send us that too. We take care of the final copywriting.',
        },
      },
      {
  ...
  /* ───────────────────────── 2. Παρουσία στο Google ───────────────────────── */
  {
    ...
    pitch: {
      el: 'Στο Google δεν κερδίζει όποιος έχει την καλύτερη σελίδα — κερδίζει όποιος έχει τις περισσότερες πρόσφατες κριτικές. Το κάναμε για εμάς: 110+ κριτικές. Το ίδιο σύστημα, στημένο για εσάς.',
      en: "On Google, the winner isn't whoever has the best website — it's whoever has the most recent reviews. We did it for ourselves: 110+ reviews. The same system, set up for you.",
    },
    pitch2: {
