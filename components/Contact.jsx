      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16 items-stretch">
          ...
          <div className="glass-panel p-8 md:p-10 rounded-3xl text-left h-full flex flex-col">
            <h3 className="text-2xl md:text-3xl font-black mb-6 text-white font-display">
              {lang === 'el' ? 'Εκδήλωση Ενδιαφέροντος' : 'Express Interest'}
            </h3>
            <p className="text-gray-400 mb-8">
              {lang === 'el' 
                ? 'Συμπληρώστε τη φόρμα και ένας εκπρόσωπός μας θα επικοινωνήσει μαζί σας μέσω email ή τηλεφώνου εντός της ίδιας ημέρας.' 
                : 'Fill out the form and a representative will contact you via email or phone within the same day.'}
            </p>
