...
// Raw SVG for Checkmarks to avoid library dependencies
const CheckIcon = () => (
...
export default function Home() {
  ...
  return (
    <>
      <section className="relative min-h-[90vh] flex items-center justify-center py-20 overflow-hidden cursor-none">
        <div className="container max-w-7xl mx-auto px-6 text-center z-10">
          ...
          <div className="reveal-item delay-4 flex flex-wrap items-center justify-center gap-6 cursor-none">
      ...
      {/* 3 Services Summary exactly from HTML */}
