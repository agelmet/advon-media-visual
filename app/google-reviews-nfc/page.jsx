...
const STEPS = [
  {
    num: '01',
    iconEl: 'Δώστε τη Βάση',
    iconEn: 'Present the Stand',
    bodyEl: 'Τοποθετήστε τη βάση NFC στο γραφείο ή τον χώρο υποδοχής σας.',
    bodyEn: 'Place the NFC stand on your desk or reception area.',
  },
  {
    num: '02',
    iconEl: 'Ο Πελάτης Ακουμπά',
    iconEn: 'Client Taps',
    bodyEl: 'Ο πελάτης ακουμπά το κινητό του στη βάση — ή σκανάρει το QR code.',
    bodyEn: 'The client taps their phone on the stand — or scans the QR code.',
  },
  {
    num: '03',
    iconEl: '5 Αστέρια Αμέσως',
    iconEn: '5 Stars Instantly',
