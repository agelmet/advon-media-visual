    ...
    <>
      ...
      <section className="py-20 border-y border-electric-cyan/10 bg-[#0a1418]/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <div className="text-4xl md:text-6xl font-black font-display text-electric-cyan mb-2 drop-shadow-[0_0_20px_rgba(71,200,245,0.3)]">3+</div>
            <div className="text-xs font-bold tracking-[0.2em] text-gray-500 uppercase">{lang === 'el' ? 'ΧΡΟΝΙΑ ΕΜΠΕΙΡΙΑΣ' : 'YEARS EXPERIENCE'}</div>
          </div>
          <div>
            <div className="text-4xl md:text-6xl font-black font-display text-electric-cyan mb-2 drop-shadow-[0_0_20px_rgba(71,200,245,0.3)]">120+</div>
            <div className="text-xs font-bold tracking-[0.2em] text-gray-500 uppercase">{lang === 'el' ? 'ΠΕΛΑΤΕΣ' : 'CLIENTS'}</div>
          </div>
          <div>
            <div className="text-4xl md:text-6xl font-black font-display text-electric-cyan mb-2 drop-shadow-[0_0_20px_rgba(71,200,245,0.3)]">100%</div>
